...
export default function Venda() {
    ...
    const { id } = useParams(); // Adicionando o id aqui
    ...
    const onSubmit: SubmitHandler<Inputs> = async (dados) => {
        try {
            ...
            const dadosParaEnviar = {
                ...dadosSemProduto,
                solicitacaoCompraId: parseInt(id), 
            ...
            await queryClient.invalidateQueries(['carrinho', id]); // Alterando params.id para id
    ...
    const finalizarCompra = async () => {
        try {
            await http.request({
                url: '/produto-solicitacao/finalizar/' + id, // Alterando params.id para id
                method: 'PUT',
            });
    ...
    const irParaNota = () => {
        push('/nota/' + id) // Alterando params.id para id
    };
